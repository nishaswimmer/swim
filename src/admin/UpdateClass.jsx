...
function UpdateClass() {
    ...
    function RegisterNow(e) {
        ...
        let data 
        if (img == "") {
           data = { classtype, agegroup, time, description, totalclass,}
        }else{
    ...
    return (
        <div className=" ml-50  box pl-20 pr-20  ">
            <div className='flex justify-center'>
                <p className='font-bold text-3xl pt-10 '>Update Class </p>
            </div>

            <form onSubmit={RegisterNow}>
                <div >
                    <label htmlFor="" className='block font-medium mb-1'> Choose File :</label>
                    <input   type="file" className=' border w-full p-2 rounded ' onChange={handleImage} />
                </div>
                ...
                <div className='flex justify-center mt-5 '>
                    <button className='border pl-3 pr-3 pt-1 pb-1 rounded bg-blue-800 text-white cursor-pointer' >Update Now</button>
                </div>
            </form>
        </div>
    )
